...
echo 'alias solidair="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/arkbridgechain/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/arkbridgechain/core'"
...
rm -rf "$HOME/.config/@solidair"
rm -rf "$HOME/.config/@solidair"
rm -rf "$HOME/.config/solidair-core"
